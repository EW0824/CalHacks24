...
def start_conversation(user_message: str) -> dict:
    ...
    if input_device_index is None or output_device_index is None:
        raise Exception("No default input/output device found.")
    ...
    # Fetch the access token and config ID
    ...
    # Start the WebSocket connection and pass in user message
